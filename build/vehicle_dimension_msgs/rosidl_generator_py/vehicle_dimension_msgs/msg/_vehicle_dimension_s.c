...
bool vehicle_dimension_msgs__msg__vehicle_dimension__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("vehicle_dimension_msgs.msg._vehicle_dimension.VehicleDimension", full_classname_dest, 62) == 0);
  }
  vehicle_dimension_msgs__msg__VehicleDimension * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of VehicleDimension */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("vehicle_dimension_msgs.msg._vehicle_dimension");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "VehicleDimension");
