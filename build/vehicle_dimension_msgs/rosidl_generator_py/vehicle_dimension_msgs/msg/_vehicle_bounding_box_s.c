...
bool vehicle_dimension_msgs__msg__vehicle_bounding_box__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("vehicle_dimension_msgs.msg._vehicle_bounding_box.VehicleBoundingBox", full_classname_dest, 67) == 0);
  }
  vehicle_dimension_msgs__msg__VehicleBoundingBox * ros_message = _ros_message;
  {  // class_id
...
{
  /* NOTE(esteve): Call constructor of VehicleBoundingBox */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("vehicle_dimension_msgs.msg._vehicle_bounding_box");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "VehicleBoundingBox");
