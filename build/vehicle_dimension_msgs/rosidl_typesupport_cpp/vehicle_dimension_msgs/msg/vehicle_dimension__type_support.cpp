...
static const _VehicleDimension_type_support_symbol_names_t _VehicleDimension_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, vehicle_dimension_msgs, msg, VehicleDimension)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, vehicle_dimension_msgs, msg, VehicleDimension)),
  }
};
...
{
  return &::vehicle_dimension_msgs::msg::rosidl_typesupport_cpp::VehicleDimension_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, vehicle_dimension_msgs, msg, VehicleDimension)() {
  return get_message_type_support_handle<vehicle_dimension_msgs::msg::VehicleDimension>();
}
